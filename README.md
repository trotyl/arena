...
13. 每一个「属性」中「攻击」的触发条件与正常「攻击」时相同, 如:
    ...
    * 「被攻击者」处于「冰冻延时效果」或「眩晕延时效果」下并满足生效条件时, 无法触发「格挡反击属性」, 「被攻击者」的「防御力」为正常情况下的「防御力」, 输出与普通「攻击」相同.
14. 不同「职业」具有不同的「移动速度」:
    * 「普通人」的「移动速度」为 1
    * 「刺客」的「移动速度」为 1.
    * 「战士」的「移动速度」为 1.
...
```
刺客张三用峨眉刺攻击了战士李四, 李四受到了8点伤害, 李四冻僵了, 李四发动了隔挡反击, 张三受到了9点伤害, 张三着火了, 张三发动了连击, 张三发动了全力一击, 李四受到了24点伤害, 李四发动了隔挡反击, 张三受到了9点伤害, 张三中毒了, 李四剩余生命: 3, 张三剩余生命: 11
```
