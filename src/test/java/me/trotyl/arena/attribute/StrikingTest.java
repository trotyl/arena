...
public class StrikingTest {
    ...
    public void apply_should_have_proper_result() {
        ...
        DamageRecord damage = striking.apply(player1, player2, Attribute.normalAttack, Attribute.normalDefence);
    ...
    public void apply_should_have_proper_invocation_with_effect() {
        ...
        striking.apply(player1, player2, Attribute.normalAttack, Attribute.normalDefence);
